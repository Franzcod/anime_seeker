...
//
//     final gifApi = gifApiFromJson(jsonString);

import 'dart:convert';

GifApi gifApiFromJson(String str) => GifApi.fromJson(json.decode(str));

String gifApiToJson(GifApi data) => json.encode(data.toJson());
...
class GifApi {
  ...
  factory GifApi.fromJson(Map<String, dynamic> json) => GifApi(
